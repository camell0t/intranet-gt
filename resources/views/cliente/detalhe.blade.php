                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($cliente->telefones as $telefone)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-default" href="{{ route('telefone.editar', $telefone->id) }}">Alterar</a>
                                        <a class="btn btn-danger" href="javascript:(confirm('Deletar esse registro?') ? window.location.href='{{ route('telefone.deletar', $telefone->id)}}' : console.log('false'))">Deletar</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>                               
